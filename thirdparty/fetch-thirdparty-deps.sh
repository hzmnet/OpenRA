...
if [ ! -f OpenAL-CS.dll -o ! -f OpenAL-CS.dll.config ]; then
	...
	curl -s -L -O https://github.com/jrb0001/OpenAL-CS/releases/download/20170520/OpenAL-CS.dll
	curl -s -L -O https://github.com/jrb0001/OpenAL-CS/releases/download/20170520/OpenAL-CS.dll.config
fi
